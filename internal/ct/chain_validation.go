...
type chainValidator struct {
	...
	// extKeyUsagesMap contains the list of EKUs to use during chain verification, for faster lookups.
	...
	// rejectExtIdsMap contains a list of X.509 extension IDs to reject during chain verification, for faster lookups.
