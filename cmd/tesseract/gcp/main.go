...
var (
	...
	awaiterPollInterval         = flag.Duration("awaiter_poll_interval", 200*time.Millisecond, "Interval between two checkpoint polls by the awaiter. Used for antispam, and if enable_publication_awaiter is set, to block add-* requests responses.")
