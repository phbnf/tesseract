...
locals {
  ...
  logs_terragrunts = ["deployment/live/gcp/static-ct-staging/logs/arche2025h1","deployment/live/gcp/static-ct-staging/logs/arche2025h2", "deployment/live/gcp/static-ct-staging/logs/throwaway"]
}
